...
@Composable
fun MenuelyOrderedProductDetailsTicket(
    id: Int = 0,
    titleText: String = "",
    imageUrl: String = "",
    amount: String = "",
    ...
    Card(
        ...
        ConstraintLayout() {
            val (imagePlaceHolder, image, title, price, ammount) = createRefs()
            Image(
            ...
            Row(
                ...
                Text(stringResource(R.string.quantity), style = MaterialTheme.typography.h3, fontSize = 14.sp)
                Text(amount, style = MaterialTheme.typography.h4,fontSize = 14.sp)
            }
        }
    }
